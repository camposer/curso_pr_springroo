...
import es.indra.formacion.pr.springroo.basico.model.PersonaDataOnDemand;
...
privileged aspect PersonaDataOnDemand_Roo_DataOnDemand {
    ...
    public void PersonaDataOnDemand.setAltura(Persona obj, int index) {
        Float altura = new Integer(index).floatValue();
    ...
    public void PersonaDataOnDemand.setFechaNacimiento(Persona obj, int index) {
