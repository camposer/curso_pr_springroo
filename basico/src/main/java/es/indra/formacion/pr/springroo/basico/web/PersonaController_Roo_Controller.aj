...
import es.indra.formacion.pr.springroo.basico.web.PersonaController;
...
privileged aspect PersonaController_Roo_Controller {
    ...
    void PersonaController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("persona_fechanacimiento_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    
    void PersonaController.populateEditForm(Model uiModel, Persona persona) {
        uiModel.addAttribute("persona", persona);
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("ordenadors", Ordenador.findAllOrdenadors());
    }
